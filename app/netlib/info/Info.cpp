...
inf::ChatInfo::ChatInfo()
    : idChat(-1), name(), checked(false) {}

inf::ChatInfo::ChatInfo(int id, const string &name, bool check)
    : idChat(id), name(name), checked(check) {}
...
const string inf::ChatInfo::nameCheck = "checked";
