...
//    info.password = "1234";
//    cache.save(info);
//    inf::MyAccount * test = cache.getMyAccount();
//    if (test == nullptr) {
...
//    cache.save(u1);
//    cache.save(u2);
//    inf::UserInfo * test = cache.getUser(204);
//    if (test == nullptr) {
//        ASSERT_EQ(test == nullptr, false);
//    } else {
...
//    int counter = 0;
//    function<void(const inf::ChatChange)> f = [&counter](const inf::ChatChange change) {counter++;};
//    Announcer announcer;
//    announcer.addChatCallback(3, f);
//    announcer.addChatCallback(4, f);
//    announcer.addChatCallback(5, f);
//    inf::ChatChange change;
//    change.idChat = 5;
//    announcer.notifyChat(change);
//    announcer.notifyChat(change);
//    announcer.notifyChat(change);
//    announcer.notifyChat(change);
//    change.idChat = 7;
...
//                  "\"idChat\": \"20\""
//                  "}";
//    inf::ChatInfo info1(20, "TEST");
//    inf::ChatInfo info2(0, "nil");
//    info2.decode(json);
//
...
//public:
//    MOCK_METHOD2(login, inf::MyAccount(string nick, string pass));
//    MOCK_METHOD1(registration, int(inf::MyAccount));
//    MOCK_METHOD1(getChatList, vector<inf::ChatInfo>(int));
//    MOCK_METHOD0(cacthChange, inf::ChatChange());
//};
//
//TEST(network, test1) {
//    // проверить Message
...
//        return;
//    }
//    EXPECT_CALL(client, login(_, _)).Times(1).WillRepeatedly(Return(inf::MyAccount()));
//    net->clientDelegate = client;
//    net->login("test", "123", [](inf::MyAccount acc){});
//}
//
//TEST(network, test2) {
...
//    net->clientDelegate = client;
//    net->registration(inf::MyAccount(), [](int a){
//        ASSERT_EQ(a, 202);
//    });
//}
//
...
//        return;
//    }
//    EXPECT_CALL(client, getChatList(_)).Times(1).WillRepeatedly(Return(vector<inf::ChatInfo>(10)));
//    net->clientDelegate = client;
//    net->getListChat(5, [](vector<inf::ChatInfo> vec) {
