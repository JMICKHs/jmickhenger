...
class DBWorkerMock : public DBWorker
{
public:
...
TEST(service, test1)
{
    DBWorkerMock db;
    JsonParserMock jp;
    NewChatService<DBWorkerMock, JsonParserMock> abs(db, jp);
...
TEST(service, test2)
{
    DBWorkerMock db;
    JsonParserMock jp;
    NewUserService<DBWorkerMock, JsonParserMock> abs(db, jp);
...
TEST(service, test3)
{
    DBWorkerMock db;
    JsonParserMock jp;
    LoginService<DBWorkerMock, JsonParserMock> abs(db, jp);
...
TEST(service, test4)
{
    DBWorkerMock db;
    JsonParserMock jp;
    LoadChatPartService<DBWorkerMock, JsonParserMock> abs(db, jp);
...
TEST(service, test5)
{
    DBWorkerMock db;
    JsonParserMock jp;
    NewMessageService<DBWorkerMock, JsonParserMock> abs(db, jp);
